...
switch husky_id
% %     case 1
% %         model_struct = load(); % Load camera model % checked
% % %         husky_config.laser_channel = 'LMS1xx_11360134_laser2d';
    case 2
        model_struct = load('full-size/BB2-13161009.mat'); % Checked
    case 3
        model_struct = load('full-size/BB2-14366971.mat'); % Checked
    case 4
        model_struct = load('full-size/BB2-14366960.mat'); % Checked
    case 5
        model_struct = load('full-size/BB2-14200208.mat'); % Checked
    otherwise
        error('Invalid Husky ID. ID = %d\n', husky_id);    
end
husky_config.laser_channel = 'LASER_SCANS';
husky_config.camera_model = model_struct.camera_model;
husky_config.wheel_odometry_channel = 'RelativePoses';
husky_config.stereo_channel = 'BUMBLEBEE2_IMAGES';
husky_config.host = '192.168.0.14';
husky_config.control_channel = 'direct_commands';
